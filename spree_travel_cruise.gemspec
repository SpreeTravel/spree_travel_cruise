...
Gem::Specification.new do |s|
  ...
  s.name        = 'spree_travel_cruise'
  s.version     = versions['spree_travel']
  s.summary     = 'Hotel into spree'
  s.description = 'Add cruise logic into spree'
  s.required_ruby_version = '>= 1.9.3'

  s.authors   = ['Raul Perez-Alejo Neyra']
  s.email     = 'info@openjaf.com'
  s.homepage  = 'http://github.com/openjaf/spree_travel_cruise'
